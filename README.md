...
# Source files
PYTHON_SRCS  := $(wildcard $(CPYTHON)/Python/*.c)
...
MODULES_SRCS := $(CPYTHON)/Modules/main.c \
                ...
                $(CPYTHON)/Modules/_io/rawiobase.c \
                ...
                $(CPYTHON)/Modules/_signalmodule.c \
                $(CPYTHON)/Modules/_tracemalloc.c \
                $(CPYTHON)/Modules/gcmodule.c \
                $(CPYTHON)/Modules/symtablemodule.c \
                $(CPYTHON)/Modules/atexitmodule.c

ALL_SRCS := $(PYTHON_SRCS) $(OBJECTS_SRCS) $(PARSER_SRCS) $(MODULES_SRCS)

# Generate object file paths
PYOBJS := $(patsubst $(CPYTHON)/%.c, obj/%.o, $(ALL_SRCS))
